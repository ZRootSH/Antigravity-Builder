...
import { Terminal, Download, ArrowRight, ShieldCheck, Cpu, Zap, Layers, CheckCircle2 } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
            ...
            <p className="text-lg sm:text-xl text-slate-300 max-w-2xl mx-auto lg:mx-0 font-normal leading-relaxed">
              El entorno de desarrollo de próxima generación impulsado por <span className="text-white font-semibold">Google DeepMind</span>. Optimizado con arquitectura multi-hilo, sin sandboxing restrictivo, y distribuido en paquetes <code className="text-neon-cyan bg-slate-900/80 px-2 py-0.5 rounded font-mono text-sm">.rpm</code> para máxima integración en Red Hat y Fedora.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
              ...
              <div className="flex items-center gap-2.5 text-slate-300 bg-surface/40 p-3 rounded-xl border border-white/5">
                ...
                <span className="text-sm font-medium">Sin --no-sandbox bugs</span>
              </div>
              <div className="flex items-center gap-2.5 text-slate-300 bg-surface/40 p-3 rounded-xl border border-white/5">
                <Zap className="w-5 h-5 text-emerald-400 shrink-0" />
                <span className="text-sm font-medium">IA Agentica 3.1 Pro</span>
              </div>
            </div>
              ...
              <div className="relative glass-card border border-slate-700/60 overflow-hidden bg-slate-950/90">
                ...
                <div className="p-5 font-mono text-xs sm:text-sm space-y-3 text-slate-300 overflow-x-auto">
                  <div className="flex items-center gap-2 text-slate-400">
                    <span className="text-emerald-400">[root@fedora ~]#</span>
                    <span className="text-white">sudo dnf install antigravity-ide</span>
                  </div>
                  
                  <div className="text-slate-400 space-y-1 pl-2 border-l-2 border-slate-800">
                    <p>Última comprobación de caducidad de metadatos: hace 0:00:12.</p>
                  ...
                  <div className="pt-2 flex items-center justify-between text-emerald-400 font-semibold bg-emerald-950/20 p-2.5 rounded border border-emerald-500/20">
                    <div className="flex items-center gap-2">
                      ...
                      <span>¡Listo! Antigravity IDE instalado correctamente.</span>
                    </div>
                  </div>
                  ...
                  <div className="mt-4 pt-3 border-t border-slate-800/80 text-slate-400 text-xs">
                    <div className="flex items-center gap-2 text-purple-400 mb-1">
                      ...
                      <span className="font-semibold">Antigravity Agentic Sidecar:</span>
                    </div>
                    <p className="text-slate-300 pl-5 italic">
                      "Entorno Linux detectado (Wayland/X11). Conectado a Gemini 3.1 Pro. Listo para programar en pareja."
                    </p>
                  </div>
                </div>
