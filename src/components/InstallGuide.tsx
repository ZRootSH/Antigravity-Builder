...
import { Terminal, Copy, Check, Server, Download, ShieldAlert, Cpu, ArrowRight } from 'lucide-react';
...
sudo dnf localinstall ./antigravity-ide-2.0.0-1.x86_64.rpm -y`;
  ...
  return (
    <section id="instalacion" className="py-24 bg-surface/30 relative">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-4 text-slate-400 text-base sm:text-lg">
            Elige entre sincronización continua con nuestro repositorio oficial <code className="text-primary-300 font-mono">dnf</code> o instalación manual por paquete local.
          </p>
        </div>
            ...
            <div className="space-y-8 animate-fadeIn">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="space-y-3 flex-1">
                  <h4 className="text-lg font-semibold text-white">
                    Añadir el archivo de repositorio a <code className="text-primary-300 font-mono text-sm bg-slate-900 px-2 py-0.5 rounded">/etc/yum.repos.d/antigravity.repo</code>
                  </h4>
                  <p className="text-sm text-slate-400">
                    Este comando crea la configuración para que el gestor de paquetes DNF/Yum apunte al contenedor automatizado de Traefik/Dokploy.
                  </p>
                  ...
                  <div className="relative rounded-xl bg-slate-950 border border-slate-800 overflow-hidden font-mono text-sm">
                    <div className="flex items-center justify-between px-4 py-2 bg-slate-900/90 border-b border-slate-800/80 text-xs text-slate-400">
                      ...
                      <button
                        onClick={() => copyToClipboard(`sudo tee /etc/yum.repos.d/antigravity.repo << 'EOF'\n${repoConfig}\nEOF`, 1)}
              ...
              <div className="flex items-start gap-4 pt-4 border-t border-slate-800/80">
                ...
                <div className="space-y-3 flex-1">
                  ...
                  <p className="text-sm text-slate-400">
                    Una vez registrado el repositorio, ejecuta la instalación estándar. DNF mantendrá tu IDE actualizado con cada release automático del pipeline.
                  </p>
            ...
            <div className="space-y-8 animate-fadeIn">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="space-y-3 flex-1">
                  ...
                  <p className="text-sm text-slate-400">
                    Si prefieres no agregar repositorios en tu sistema, descarga directamente el paquete precompilado y resuélvelo usando <code className="text-purple-300 font-mono text-sm bg-slate-900 px-2 py-0.5 rounded">dnf localinstall</code>.
                  </p>
              ...
              <div className="bg-slate-900/80 border border-purple-500/20 rounded-xl p-4 flex items-start gap-3">
                ...
                <div className="text-xs sm:text-sm text-slate-300">
                  <span className="font-semibold text-white">Nota de actualización:</span> Al usar el método manual, deberás descargar manualmente las futuras versiones que el servicio <code className="text-purple-300 font-mono">repo-builder</code> empaque en el volumen. Para actualizaciones automáticas sin intervención, recomendamos usar el Método Automático.
                </div>
              </div>
